...
INSERT INTO document_chunks (id, document_id, project_id, content, chunk_index, page_number) VALUES
  ...
  ('00000000-0000-0000-0000-000000000503', '00000000-0000-0000-0000-000000000402', '00000000-0000-0000-0000-000000000301', 'The team decided to store embeddings in FAISS and keep only vector_store, vector_id, and embedding_model in PostgreSQL.', 0, 1),
...
INSERT INTO chunk_embeddings (id, chunk_id, vector_store, vector_id, embedding_model) VALUES
  ('00000000-0000-0000-0000-000000000511', '00000000-0000-0000-0000-000000000501', 'faiss', 'chunk_000501', 'text-embedding-3-small'),
  ('00000000-0000-0000-0000-000000000512', '00000000-0000-0000-0000-000000000502', 'faiss', 'chunk_000502', 'text-embedding-3-small'),
  ('00000000-0000-0000-0000-000000000513', '00000000-0000-0000-0000-000000000503', 'faiss', 'chunk_000503', 'text-embedding-3-small'),
  ('00000000-0000-0000-0000-000000000514', '00000000-0000-0000-0000-000000000504', 'faiss', 'chunk_000504', 'text-embedding-3-small'),
  ('00000000-0000-0000-0000-000000000515', '00000000-0000-0000-0000-000000000505', 'faiss', 'chunk_000505', 'text-embedding-3-small'),
  ('00000000-0000-0000-0000-000000000516', '00000000-0000-0000-0000-000000000506', 'faiss', 'chunk_000506', 'text-embedding-3-small');
...
INSERT INTO issues (
  ...
  ('00000000-0000-0000-0000-000000000701', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000103', '00000000-0000-0000-0000-000000000402', 'Citation format not finalized', 'The assistant answer citation payload is not locked yet.', 'critical', 'open'),
  ('00000000-0000-0000-0000-000000000702', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000104', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000401', 'Delayed handoff checklist review', 'Deployment and test coverage items must be added before handoff.', 'high', 'in_progress'),
  ('00000000-0000-0000-0000-000000000703', '00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000104', '00000000-0000-0000-0000-000000000403', 'Dashboard response schema needs sign-off', 'Frontend and backend field names must be aligned.', 'medium', 'open');
...
INSERT INTO chat_messages (id, project_id, user_id, role, content, sources_json, created_at) VALUES
  ...
  ('00000000-0000-0000-0000-000000000715', '00000000-0000-0000-0000-000000000301', NULL, 'system', 'Document ingestion finished for 2 of 3 uploaded documents.', '[]'::jsonb, '2026-05-13 11:10:00+09');
