-- DBeaver one-shot reset for OpsRadar2.
-- Run this whole file with Alt+X / Execute SQL Script.
-- WARNING: this deletes all data inside the opsradar2 schema.

DROP SCHEMA IF EXISTS opsradar2 CASCADE;
CREATE SCHEMA opsradar2;
